...
let currentUser = "", userData = { money: 0, diamond: 0, cars: ['kancil'], pass: "" }, selCarKey = 'kancil', p2CarKey = 'kancil';
let currentMapKey = 'cybercity', running = false, lastTime = 0, moveTimer = 0, px = 1, py = 4, sessionCash = 0, curLives = 0;
...
function continueGame() {
    ...
    if(isMultiplayer) p2Lives = CARS[p2CarKey].hp; // Pakai p2CarKey
